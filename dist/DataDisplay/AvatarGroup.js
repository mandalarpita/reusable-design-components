...
var _excluded = ["size", "variant", "children", "elementid", "className"];
...
var AvatarGroup = function AvatarGroup(props) {
  ...
  var classes = (0, _customClasses.getClassBySize)(size, "customAvatar");
  if (children && Array.isArray(children) && children.length > 0) children = children.map(function (child) {
  ...
  return /*#__PURE__*/React.createElement(_material.AvatarGroup, _extends({
    elementid: elementid,
